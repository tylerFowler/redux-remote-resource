...
**/
export default function callRemoteResource(request, statusActions, hooks, userFetch) {
  // order of fetch priority: user supplied fetch -> global fetch -> isomorphic-fetch
  const f = userFetch || fetch || isomorphicFetch;
